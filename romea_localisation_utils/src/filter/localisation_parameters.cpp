...
const std::string PREDICTOR_MAXIMAL_DEAD_RECKONING_TRAVELLED_DISTANCE_PARAM_NAME=
    "configuration.predictor.maximal_dead_recknoning_travelled_distance";
const std::string PREDICTOR_MAXIMAL_DEAD_RECKONING_ELAPSED_TIME_PARAM_NAME=
    "configuration.predictor.maximal_dead_recknoning_elapsed_time";
const std::string PREDICTOR_MAXIMAL_POSITION_CIRCULAR_ERROR_PROBABLE_PARAM_NAME=
    "configuration.predictor.maximal_position_circular_error_probability";

const std::string FILTER_NUMBER_OF_PARTICLES_PARAM_NAME ="configuration.filter.number_of_particles";
const std::string FILTER_STATE_POOL_SIZE_PARAM_NAME ="configuration.filter.state_pool_size";

const std::string UPDATER_TRIGGER_PARAM_NAME = "trigger";
const std::string UPDATER_TOPIC_PARAM_NAME = "topic";
const std::string UPDATER_MINIMAL_RATE_PARAM_NAME = "minimal_rate";
const std::string UPDATER_MAHALANOBIS_DISTANCE_REJECTION_THRESHOLD_PARAM_NAME = "mahalanobis_distance_rejection_threshold";
...
//-----------------------------------------------------------------------------
void declare_updater_maximal_mahalanobis_distance(std::shared_ptr<rclcpp::Node> node,
                                                  std::string updater_name)
{
  declare_parameter_with_default<int>(
