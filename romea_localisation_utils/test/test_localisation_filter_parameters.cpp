...
#include "romea_localisation_utils/filter/localisation_filter_parameters.hpp"
...
//-----------------------------------------------------------------------------
TEST_F(TestLocalisationFilterParams, checkGetTOTO)
{
  romea::declare_updater_mahalanobis_distance_rejection_threshold(node,"bar");
  std::cout << " coucou" << std::endl;
  std::cout << " cocou " << node->has_parameter("bar.mahalanobis_distance_rejection_threshold")<<std::endl;
}
